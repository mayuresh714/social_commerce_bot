...
class text_mining():
    ...
    def execute(self,states):
        ...
        try:
            ...
            if states == "e0" and 'subcat' in cur_rec:
                cur_rec.update({"enquiry":["show"]})
                #if 'order' in cur_rec:
